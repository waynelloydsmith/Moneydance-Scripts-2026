...
The action remaps are handled by the jython scripts and will require some script editing. Most are simple but a few get more complex if shares or amount is present or not. 
Negative Dividends are a pain in the ... moneydance does not like negative dividends. I have captured them and changed them to miscexp transactions. These occure normaly because a company has made a mistake and issued an incorrect dividend. They will then issue a negative dividend and a new positive one. The account balance will be ok but the preformance gets messed up. So after an import you can track down the miscexp transactions and delete the negative one and its matching positive mistake manually. 
...
I'm trying to get rid of the cards that don't have at least a year of online data available. Thats why CIBC has entered my world. My Costco card has data available back to 2011.
